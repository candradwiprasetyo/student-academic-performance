    ...
    <div class="w-full h-screen md:flex">
      <div class="flex-1 bg-cover bg-center relative bg-primary content-center flex items-center w-full min-h-[200px]">
        <div class="absolute bg-blue-300 inset-0 opacity-50">
          <img
              src="~/assets/images/binus-logo-white.png"
      ...
      <div class="flex-1 content-center flex items-center px-8 md:px-0">
        <div class="w-full md:w-[400px] mx-auto font-medium py-8 md:py-0">
          <div class="hidden md:inline">
            <img
              src="~/assets/images/binus-logo.png"
              class="mx-auto mb-10"
              alt="Logo"
              width="164"
              height="164"
          ...
          <div v-if="true">
            <div class="text-xl font-extrabold font-montserrat text-center">Student Academic Performance</div>
          ...
          <div class="mt-2 md:mt-4 text-center text-2xs font-medium">Copyright © {{ new Date().getFullYear() }} studentacademicperformance.net. All rights reserved.</div>
        </div>
      </div>
    </div>
  </div>
