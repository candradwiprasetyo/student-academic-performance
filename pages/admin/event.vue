  ...
  <div>
    <div class="rounded-lg p-8 bg-white shadow">
      <div class="flex justify-between">
        ...
        <a href="/add-event"  v-if="dataUser.role_id==1">
      ...
      <div class="border-primary-4 rounded-lg mt-4">
        <table class="w-full">
          <tr class="text-xs md:text-sm text-left border-b-2 border-gray-100 font-black">
            ...
            <th width="20%" class="p-2 px-2 md:px-4">Event Time</th>
            <th width="12%" class="p-2 px-2 md:px-4" v-if="dataUser.role_id==1">Published Status</th>
            <th width="12%" class="p-2 px-2 md:px-4" v-if="dataUser.role_id==1">Event Status</th>
          ...
          <tr class="text-2xs md:text-xs border-b-2 border-gray-100" v-for="event in dataEvent" :key="event.id" v-if="isLoading==false">
            ...
            <td class="py-3 md:py-2 px-1 md:px-4" v-if="dataUser.role_id==1">
              <div 
